"use client";
import { TaskListFetchResult, useTaskList } from "@/domain/tasks/hooks/use-task-list";
...
export default function DashboardPage({ initialData }: { initialData?: TaskListFetchResult }) {
    const {
        tasks = [],
        total,
        isLoading,
